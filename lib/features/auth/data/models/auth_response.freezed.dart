...
@JsonKey(readValue: _readToken) String get token; UserModel? get user;
...
@useResult
$Res call({
@JsonKey(readValue: _readToken) String token, UserModel? user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(readValue: _readToken)  String token,  UserModel? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(readValue: _readToken)  String token,  UserModel? user)  $default,) {final _that = this;
switch (_that) {
case _AuthResponse():
return $default(_that.token,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(readValue: _readToken)  String token,  UserModel? user)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
return $default(_that.token,_that.user);case _:
  return null;
...
class _AuthResponse extends AuthResponse {
  const _AuthResponse({@JsonKey(readValue: _readToken) required this.token, this.user}): super._();
